                      ...
                      <div class="py-4 px-3 text-white">
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                            <?php
                                $nbr_hosp_imp=DB::table('tbl_analyse')
                                ...
                                date('Y-m-D'))
                                          ...
                                          ->count();
                            ?>
                              <h2 style="color:WHITE;" class="m-0 lh-1">{{$nbr_hosp_imp}}</h2>


                              <p style="color:WHITE;" class="m-0"> Analyses </p>
                            <?php  ?>
                            </div>
                          </div>
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="d-flex flex-column">
                              <?php
                                  $nbr_anal_jr=DB::table('tbl_analyse')
                                            ->where('statut_analyse',0)
                                            ->whereDate('created_at', '=',
                                            date('Y-m-d'))
                                            ->count();
                              ?>
                                <h2 class="m-0 lh-1">{{$nbr_anal_jr}}</h2>
                  ...
                  <table class="table m-0 align-middle">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>73</td>
                        <td>
                          <img src="{{asset('frontend/images/user1.png')}}" class="img-shadow img-2x rounded-5 me-1"
                            alt="Hospital Admin Template">
                          April Gallegos
                        </td>
                        <td>Gynecologist</td>
                      ...
                      <tr>
                        ...
                        <td>84</td>
                        <td>
                          <img src="{{asset('frontend/images/user2.png')}}" class="img-shadow img-2x rounded-5 me-1"
                            alt="Hospital Admin Template">
                          Basil Frost
                        </td>
                        <td>Psychiatrists</td>
                      ...
                      <tr>
                        ...
                        <td>56</td>
                        <td>
                          <img src="{{asset('frontend/images/user4.png')}}" class="img-shadow img-2x rounded-5 me-1"
                            alt="Hospital Admin Template">
                          Nannie Guerrero
                        </td>
                        <td>Urologist</td>
                      ...
                      <tr>
                        ...
                        <td>49</td>
                        <td>
                          <img src="{{asset('frontend/images/user5.png')}}" class="img-shadow img-2x rounded-5 me-1"
                            alt="Hospital Admin Template">
                          Daren Andrade
                        </td>
                        <td>Cardiology</td>
