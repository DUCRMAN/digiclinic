              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5 class="card-title">Création d'un service</h5>
                  </div>
                  <div class="card-body">
                   ...
                   {{-- @if(session('ServiceCreated'))
                    ...
                    @endif --}}
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="a1" name="code_serve" placeholder="Nom du service" required>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          <label class="form-label" for="libelle">Libellé du service</label>
                          <input type="text" class="form-control" id="libelle" name="libelle" placeholder="Nom du service" required>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                      ...
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="a5" name="telephone" placeholder="Entrez le téléphone du service" required>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
