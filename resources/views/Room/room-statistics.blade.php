...
<html lang="en">
  ...
  <body>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview active current-page">
                <a href="#!">
                  ...
                  <span class="menu-text">Rooms Available</span>
                </a>
                <ul class="treeview-menu">
                  <li>
                    <a href="room-statistics.html" class="active-sub">Statistics</a>
                  </li>
                  <li>
    ...
    <script src="assets/vendor/apex/custom/rooms/admissions.js"></script>
